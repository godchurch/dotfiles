...
[[ $TERM =~ ^xterm-color|-256color$ ]] && USE_COLOR="yes" || USE_COLOR="no"
[[ $TERM =~ ^xterm|^rxvt|^tmux ]] && type tty &> /dev/null && printf '\033]2;%d:%s\007' "$$" "$(tty)"
...
if [[ $USE_COLOR == 'yes' ]]; then
	PROMPT_COLOR_RESET='\001\033[0m\002'
	PROMPT_COLOR_STANDARD='\001\033[0m\033[1;38;5;249m\002'
	PROMPT_COLOR_DIRECTORY='\001\033[0m\033[1;38;5;38m\002'
	PROMPT_COLOR_ERROR='\001\033[0m\033[1;38;5;161m\002'
else
	PROMPT_COLOR_RESET=
	PROMPT_COLOR_STANDARD=
	PROMPT_COLOR_DIRECTORY=
	PROMPT_COLOR_ERROR=
fi
